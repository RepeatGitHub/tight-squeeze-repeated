...
`));
  ...
  var music;
  var mouse = vec2();
  onmousemove = /* @__PURE__ */ __name((e) => {
    mouse.x = Math.floor((e.x - canvas.getBoundingClientRect().x) / canvas.getBoundingClientRect().width * 1e3);
    mouse.y = Math.floor((e.y - canvas.getBoundingClientRect().y) / canvas.getBoundingClientRect().height * 1e3);
  }, "onmousemove");
  ...
  scene("welcome", () => {
    ...
    keyPress("space", () => __async(void 0, null, function* () {
      for (let i = 0; i < 10; i++) {
        overlay.opacity += 0.1;
        yield wait(0);
      }
  ...
  scene("levelSelect", () => __async(void 0, null, function* () {
    ...
    for (let i = 1; i <= 4; i++) {
      for (let j = 1; j <= 2; j++) {
        ...
        let clicked = false;
        box.onHover = () => __async(void 0, null, function* () {
          box.scaleTo(1.5);
          box.moveTo(200 * i - 75, 250 * j - 25);
          txt2.scaleTo(1.5);
          txt2.moveTo(200 * i - txt2.width * 0.75, 250 * j + 50 - txt2.height * 0.75);
          cursor("pointer");
